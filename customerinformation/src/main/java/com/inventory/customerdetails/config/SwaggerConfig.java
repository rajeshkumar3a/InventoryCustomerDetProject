/*
 * package com.inventory.customerdetails.config;
 * 
 ...
 * {
 * 
 * @Bean public Docket purchaseApi() { return new
 * Docket(DocumentationType.SWAGGER_2) .select()
 * .apis(RequestHandlerSelectors.basePackage(
 * "com.inventory.customerdetails.controller"))
 * .paths(regex("/InvCustDetails.*")) .build(); }
 * 
